...
export default {
  ...
  data () {
    return {
      ...
      {src: 'unnamed (5).jpg', name: '頭部', des: '頭部塗裝非常簡單,但是卻也非常耗時;先將頭部透明件取出,之後噴上一層深灰色(TAMIYA XF-24),等深灰色完全乾燥後,最煩人的部分就來了,畫面中所看到的銀色全部都是一層一層乾掃出來的,而乾掃這個步驟必須要等一層乾了才能進行下一層,所以塗完整顆頭至少會花費掉3~4的時間。'},
